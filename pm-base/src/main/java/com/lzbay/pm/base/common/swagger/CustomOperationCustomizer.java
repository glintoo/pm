package com.lzbay.pm.base.common.swagger;

import cn.dev33.satoken.annotation.SaCheckPermission;
import cn.dev33.satoken.annotation.SaCheckRole;
import cn.dev33.satoken.annotation.SaMode;
import cn.hutool.core.util.StrUtil;
import com.lzbay.pm.base.modules.annotation.ApiDecrypt;
import com.lzbay.pm.base.modules.annotation.ApiEncrypt;
...
public class CustomOperationCustomizer implements OperationCustomizer {
    ...
    public Operation customize(Operation operation, HandlerMethod handlerMethod) {
        ...
        if (!encryptBuilderList.isEmpty()) {
            noteList.add("<br/><font style=\"color:red\" class=\"light-red\">接口安全：" + StrUtil.join(",", encryptBuilderList) + "</font>");
        }
