package com.lzbay.pm.business.modules.system.department.manager;

import cn.hutool.core.collection.CollectionUtil;
import com.google.common.collect.Lists;
import com.google.common.collect.Maps;
import com.lzbay.pm.base.common.utils.CustomBeanUtil;
import com.lzbay.pm.business.constant.AdminCacheConst;
...
public class DepartmentCacheManager {
    ...
    public List<DepartmentTreeVO> buildTree(List<DepartmentVO> voList) {
        ...
        List<DepartmentTreeVO> treeVOList = CustomBeanUtil.copyList(rootList, DepartmentTreeVO.class);
    ...
    private List<Long> recursiveBuildTree(List<DepartmentTreeVO> nodeList, List<DepartmentVO> allDepartmentList) {
        ...
        for(int i = 0; i < nodeSize; i++) {
            ...
            if(CollectionUtil.isEmpty(node.getSelfAndAllChildrenIdList())) {
            ...
            if(CollectionUtil.isNotEmpty(tempChildIdList)) {
    ...
    private List<DepartmentTreeVO> getChildren(Long departmentId, List<DepartmentVO> voList) {
        ...
        if (CollectionUtil.isEmpty(childrenEntityList)) {
            return Lists.newArrayList();
        }
        return CustomBeanUtil.copyList(childrenEntityList, DepartmentTreeVO.class);
    }
